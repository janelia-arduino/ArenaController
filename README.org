...
#+BEGIN_SRC plantuml :file ./documentation/images/state-diagram-watchdog.svg :results none
@startuml
!theme spacelab
...
#+html: <img src="./documentation/images/SM_of_SerialCommandInterface.png" width="1200px">

**** EthernetCommandInterface

#+html: <img src="./documentation/images/SM_of_EthernetCommandInterface.png" width="1200px">

**** Pattern

#+html: <img src="./documentation/images/SM_of_Pattern.png" width="1200px">

**** Card

#+html: <img src="./documentation/images/SM_of_Card.png" width="1200px">

**** Arena

#+html: <img src="./documentation/images/SM_of_Arena.png" width="1200px">

**** AnalogOutput

#+html: <img src="./documentation/images/SM_of_AnalogOutput.png" width="1200px">

**** AnalogInput

#+html: <img src="./documentation/images/SM_of_AnalogInput.png" width="1200px">

**** Display

#+html: <img src="./documentation/images/SM_of_Display.png" width="1200px">

**** Frame

#+html: <img src="./documentation/images/SM_of_Frame.png" width="1200px">
