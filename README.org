...
#+BEGIN_SRC sh
pixi run build examples/MongooseTest
...
#+BEGIN_SRC sh
pixi run upload
pixi run upload examples/ArenaControllerTeensy12-12 /dev/ttyACM1
pixi run upload examples/ArenaControllerTeensy12-12 /dev/cu.usbmodem1234
pixi run upload examples/ArenaControllerTeensy12-12 COM3
#+END_SRC

Upload other examples:

#+BEGIN_SRC sh
pixi run upload examples/MongooseTest
pixi run upload examples/MongooseTest /dev/ttyACM1

pixi run upload examples/SDCardDebugTest
pixi run upload examples/SDCardDebugTest /dev/ttyACM1

pixi run upload examples/WatchdogTest
pixi run upload examples/WatchdogTest /dev/ttyACM1
#+END_SRC
