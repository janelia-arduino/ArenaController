...
private:
  ...
  uint8_t output_buffers_[panels_controller::constants::SPI_COUNT_PER_ARENA][panels_controller::constants::BYTE_COUNT_PER_PANEL_GRAYSCALE];
  uint8_t input_buffers_[panels_controller::constants::SPI_COUNT_PER_ARENA][panels_controller::constants::BYTE_COUNT_PER_PANEL_GRAYSCALE];
