...
//     All GPIO is delegated to BSP::{perfRefreshTickToggle, perfFrameTransferSet,
//     perfFetchSet} implemented in examples/<board>/bsp.cpp.
...
// ISR-level hook: called when refresh ISR attempts to POST the refresh timeout.
// If post_ok==false, the refresh tick was dropped at the source.
...
// Intended to be called at end-of-pattern (e.g., in Pattern_endRuntimeDuration)
// or other session end.
...
static inline void begin_session (SessionMode, uint16_t, uint32_t) {}
static inline void end_session () {}
static inline void on_refresh_isr_post (bool) {}
static inline void on_refresh_defer (bool) {}
static inline void on_defer_attempt (bool) {}
static inline void on_frame_start (uint16_t) {}
static inline void on_frame_end () {}
static inline void on_panelset_start () {}
static inline void on_panelset_end () {}
static inline void fetch_begin () {}
static inline void fetch_end () {}
static inline void stage_begin (Stage) {}
static inline void stage_end (Stage) {}
static inline void qs_report_session (uint8_t, const char *) {}
static inline PerfStatsPayload snapshot_payload_v1 () { return PerfStatsPayload{}; }
static inline PerfStatsPayload snapshot_payload () { return PerfStatsPayload{}; }
static inline void format_summary (char *, size_t) {}
static inline Snapshot snapshot () { return Snapshot{}; }
