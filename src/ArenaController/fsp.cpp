...
static QEvt const process_binary_command_evt = {PROCESS_BINARY_COMMAND_SIG, 0U,
                                                0U};
static QEvt const process_string_command_evt = {PROCESS_STRING_COMMAND_SIG, 0U,
                                                0U};
static QEvt const process_stream_command_evt = {PROCESS_STREAM_COMMAND_SIG, 0U,
                                                0U};
static QEvt const command_processed_evt = {COMMAND_PROCESSED_SIG, 0U, 0U};
static QEvt const pattern_finished_playing_evt = {PATTERN_FINISHED_PLAYING_SIG,
                                                  0U, 0U};
...
static QEvt const serial_command_available_evt = {SERIAL_COMMAND_AVAILABLE_SIG,
                                                  0U, 0U};
...
static QEvt const begin_playing_pattern_evt = {BEGIN_PLAYING_PATTERN_SIG, 0U,
                                               0U};
...
static QEvt const directory_open_success_evt = {DIRECTORY_OPEN_SUCCESS_SIG, 0U,
                                                0U};
static QEvt const directory_open_failure_evt = {DIRECTORY_OPEN_FAILURE_SIG, 0U,
                                                0U};
static QEvt const filename_sort_success_evt = {FILENAME_SORT_SUCCESS_SIG, 0U,
                                               0U};
static QEvt const filename_sort_failure_evt = {FILENAME_SORT_FAILURE_SIG, 0U,
                                               0U};
...
static QEvt const initialize_analog_output_evt = {INITIALIZE_ANALOG_OUTPUT_SIG,
                                                  0U, 0U};
static QEvt const analog_output_initialized_evt = {
    ANALOG_OUTPUT_INITIALIZED_SIG, 0U, 0U};

static QEvt const initialize_analog_input_evt = {INITIALIZE_ANALOG_INPUT_SIG,
                                                 0U, 0U};
static QEvt const analog_input_initialized_evt = {ANALOG_INPUT_INITIALIZED_SIG,
                                                  0U, 0U};
}  // namespace constants
}  // namespace AC
//----------------------------------------------------------------------------
...
void FSP::ArenaController_setup() {
  ...
  AO_EthernetCommandInterface->start(3U,  // priority
                                     ...
                                     Q_DIM(ethernet_command_interface_queueSto),
                                     (void*)0, 0U);  // no stack
...
void FSP::Arena_fillFrameBufferWithDecodedFrame(QActive* const ao,
                                                QEvt const* e) {
...
void FSP::Arena_streamFrameTransition(QP::QActive* const ao,
                                      QP::QEvt const* e) {
  Arena_deactivateDisplay(ao, e);
}

void FSP::Arena_playPatternTransition(QP::QActive* const ao,
                                      QP::QEvt const* e) {
  Arena_deactivateDisplay(ao, e);
}
...
void FSP::Arena_showPatternFrameTransition(QP::QActive* const ao,
                                           QP::QEvt const* e) {
  Arena_deactivateDisplay(ao, e);
}
...
void FSP::Arena_analogClosedLoopTransition(QP::QActive* const ao,
                                           QP::QEvt const* e) {
  Arena_deactivateDisplay(ao, e);
}

void FSP::Arena_beginAnalogClosedLoop(QP::QActive* const ao,
                                      QP::QEvt const* e) {
  Arena* const arena = static_cast<Arena* const>(ao);
...
void FSP::SerialCommandInterface_initializeAndSubscribe(QActive* const ao,
                                                        QEvt const* e) {
...
void FSP::SerialCommandInterface_armSerialTimerLowSpeed(QActive* const ao,
                                                        QEvt const* e) {
  SerialCommandInterface* const sci =
      static_cast<SerialCommandInterface* const>(ao);
...
void FSP::SerialCommandInterface_armSerialTimerHighSpeed(QActive* const ao,
                                                         QEvt const* e) {
  SerialCommandInterface* const sci =
      static_cast<SerialCommandInterface* const>(ao);
  sci->serial_time_evt_.disarm();
...
void FSP::SerialCommandInterface_disarmSerialTimer(QActive* const ao,
                                                   QEvt const* e) {
  SerialCommandInterface* const sci =
      static_cast<SerialCommandInterface* const>(ao);
  sci->serial_time_evt_.disarm();
...
void FSP::SerialCommandInterface_initializeSerial(QActive* const ao,
                                                  QEvt const* e) {
...
void FSP::SerialCommandInterface_analyzeCommand(QActive* const ao,
                                                QEvt const* e) {
  SerialCommandInterface* const sci =
      static_cast<SerialCommandInterface* const>(ao);
...
void FSP::SerialCommandInterface_processBinaryCommand(QActive* const ao,
                                                      QEvt const* e) {
  SerialCommandInterface* const sci =
      static_cast<SerialCommandInterface* const>(ao);
...
void FSP::SerialCommandInterface_writeBinaryResponse(QActive* const ao,
                                                     QEvt const* e) {
  SerialCommandInterface* const sci =
      static_cast<SerialCommandInterface* const>(ao);
...
void FSP::SerialCommandInterface_updateStreamCommand(QActive* const ao,
                                                     QEvt const* e) {
  SerialCommandInterface* const sci =
      static_cast<SerialCommandInterface* const>(ao);
...
bool FSP::SerialCommandInterface_ifStreamCommandComplete(QActive* const ao,
                                                         QEvt const* e) {
  SerialCommandInterface* const sci =
      static_cast<SerialCommandInterface* const>(ao);
...
void FSP::SerialCommandInterface_processStreamCommand(QActive* const ao,
                                                      QEvt const* e) {
  SerialCommandInterface* const sci =
      static_cast<SerialCommandInterface* const>(ao);
...
void FSP::SerialCommandInterface_storePlayPatternParameters(QActive* const ao,
                                                            QEvt const* e) {
  SerialCommandInterface* const sci =
      static_cast<SerialCommandInterface* const>(ao);
  PlayPatternEvt const* ppev = static_cast<PlayPatternEvt const*>(e);

  sci->runtime_duration_ms_ = ppev->runtime_duration *
                              constants::milliseconds_per_runtime_duration_unit;
}

void FSP::SerialCommandInterface_storeAnalogClosedLoopParameters(
    QActive* const ao, QEvt const* e) {
  SerialCommandInterface* const sci =
      static_cast<SerialCommandInterface* const>(ao);
  AnalogClosedLoopEvt const* aclev = static_cast<AnalogClosedLoopEvt const*>(e);

  sci->runtime_duration_ms_ = aclev->runtime_duration *
                              constants::milliseconds_per_runtime_duration_unit;
}

void FSP::SerialCommandInterface_writePatternFinishedResponse(QActive* const ao,
                                                              QEvt const* e) {
  SerialCommandInterface* const sci =
      static_cast<SerialCommandInterface* const>(ao);
...
void FSP::SerialCommandInterface_writePatternErrorResponse(QActive* const ao,
                                                           QEvt const* e) {
  uint8_t response[constants::byte_count_per_pattern_finished_response_max];
  uint8_t response_byte_count = 0;
  response[response_byte_count++] = 2;
...
void FSP::EthernetCommandInterface_initializeAndSubscribe(QActive* const ao,
                                                          QEvt const* e) {
  ao->subscribe(SERIAL_COMMAND_AVAILABLE_SIG);
  ao->subscribe(ETHERNET_COMMAND_AVAILABLE_SIG);
  ao->subscribe(PROCESS_BINARY_COMMAND_SIG);
...
void FSP::EthernetCommandInterface_armEthernetTimerLowSpeed(QActive* const ao,
                                                            QEvt const* e) {
  EthernetCommandInterface* const eci =
      static_cast<EthernetCommandInterface* const>(ao);
...
void FSP::EthernetCommandInterface_armEthernetTimerHighSpeed(QActive* const ao,
                                                             QEvt const* e) {
  EthernetCommandInterface* const eci =
      static_cast<EthernetCommandInterface* const>(ao);
  eci->ethernet_time_evt_.disarm();
...
void FSP::EthernetCommandInterface_disarmEthernetTimer(QActive* const ao,
                                                       QEvt const* e) {
  EthernetCommandInterface* const eci =
      static_cast<EthernetCommandInterface* const>(ao);
  eci->ethernet_time_evt_.disarm();
...
void FSP::EthernetCommandInterface_initializeEthernet(QActive* const ao,
                                                      QEvt const* e) {
...
void FSP::EthernetCommandInterface_pollEthernet(QActive* const ao,
                                                QEvt const* e) {
  BSP::pollEthernet();
}

void FSP::EthernetCommandInterface_createServerConnection(QActive* const ao,
                                                          QEvt const* e) {
  bool server_connected = BSP::createEthernetServerConnection();
  if (server_connected) {
    AO_EthernetCommandInterface->POST(&constants::ethernet_server_connected_evt,
                                      ao);
  }
}

void FSP::EthernetCommandInterface_analyzeCommand(QActive* const ao,
                                                  QEvt const* e) {
  EthernetCommandInterface* const eci =
      static_cast<EthernetCommandInterface* const>(ao);
...
void FSP::EthernetCommandInterface_processBinaryCommand(QActive* const ao,
                                                        QEvt const* e) {
  EthernetCommandInterface* const eci =
      static_cast<EthernetCommandInterface* const>(ao);
...
void FSP::EthernetCommandInterface_writeBinaryResponse(QActive* const ao,
                                                       QEvt const* e) {
  EthernetCommandInterface* const eci =
      static_cast<EthernetCommandInterface* const>(ao);
...
void FSP::EthernetCommandInterface_updateStreamCommand(QActive* const ao,
                                                       QEvt const* e) {
  EthernetCommandInterface* const eci =
      static_cast<EthernetCommandInterface* const>(ao);
  CommandEvt const* cev = static_cast<CommandEvt const*>(e);
...
bool FSP::EthernetCommandInterface_ifStreamCommandComplete(QActive* const ao,
                                                           QEvt const* e) {
  EthernetCommandInterface* const eci =
      static_cast<EthernetCommandInterface* const>(ao);
...
void FSP::EthernetCommandInterface_processStreamCommand(QActive* const ao,
                                                        QEvt const* e) {
  EthernetCommandInterface* const eci =
      static_cast<EthernetCommandInterface* const>(ao);
...
void FSP::EthernetCommandInterface_storePlayPatternParameters(QActive* const ao,
                                                              QEvt const* e) {
  EthernetCommandInterface* const eci =
      static_cast<EthernetCommandInterface* const>(ao);
  PlayPatternEvt const* ppev = static_cast<PlayPatternEvt const*>(e);

  eci->runtime_duration_ms_ = ppev->runtime_duration *
                              constants::milliseconds_per_runtime_duration_unit;
}

void FSP::EthernetCommandInterface_storeAnalogClosedLoopParameters(
    QActive* const ao, QEvt const* e) {
  EthernetCommandInterface* const eci =
      static_cast<EthernetCommandInterface* const>(ao);
  AnalogClosedLoopEvt const* aclev = static_cast<AnalogClosedLoopEvt const*>(e);

  eci->runtime_duration_ms_ = aclev->runtime_duration *
                              constants::milliseconds_per_runtime_duration_unit;
}

void FSP::EthernetCommandInterface_writePatternFinishedResponse(
    QActive* const ao, QEvt const* e) {
  EthernetCommandInterface* const eci =
      static_cast<EthernetCommandInterface* const>(ao);
  uint8_t response[constants::byte_count_per_pattern_finished_response_max];
...
void FSP::EthernetCommandInterface_writePatternErrorResponse(QActive* const ao,
                                                             QEvt const* e) {
  EthernetCommandInterface* const eci =
      static_cast<EthernetCommandInterface* const>(ao);
  uint8_t response[constants::byte_count_per_pattern_finished_response_max];
...
void FSP::Frame_fillFrameBufferWithDecodedFrame(QActive* const ao,
                                                QEvt const* e) {
  Frame* const frame = static_cast<Frame* const>(ao);
  FrameEvt* fe = Q_NEW(FrameEvt, FRAME_FILLED_SIG);
...
void FSP::Pattern_initializeAndSubscribe(QActive* const ao, QEvt const* e) {
  ...
  pattern->begin_pattern_queue_.init(pattern_begin_pattern_queue_store,
...
void FSP::Pattern_initializeAnalogClosedLoop(QActive* const ao, QEvt const* e) {
  Pattern* const pattern = static_cast<Pattern* const>(ao);
  AnalogClosedLoopEvt const* aclev = static_cast<AnalogClosedLoopEvt const*>(e);
...
void FSP::Pattern_deleteFrameReference(QP::QActive* const ao,
                                       QP::QEvt const* e) {
  Pattern* const pattern = static_cast<Pattern* const>(ao);
  if (pattern->frame_) {
    Q_DELETE_REF(pattern->frame_);
...
void FSP::Pattern_fillFrameBufferWithDecodedFrame(QActive* const ao,
                                                  QEvt const* e) {
  // QS_BEGIN_ID(USER_COMMENT, ao->m_prio)
...
void FSP::Pattern_setFrameCountPerPattern(QP::QActive* const ao,
                                          QP::QEvt const* e) {
  Pattern* const pattern = static_cast<Pattern* const>(ao);
  UnsignedValueEvt const* uvev = static_cast<UnsignedValueEvt const*>(e);
...
void FSP::Pattern_setByteCountPerFrame(QP::QActive* const ao,
                                       QP::QEvt const* e) {
  Pattern* const pattern = static_cast<Pattern* const>(ao);
  UnsignedValueEvt const* uvev = static_cast<UnsignedValueEvt const*>(e);
...
void FSP::Pattern_setGrayscaleAndDispatchToCard(QP::QActive* const ao,
                                                QP::QEvt const* e) {
  Pattern* const pattern = static_cast<Pattern* const>(ao);
  UnsignedValueEvt const* uvev = static_cast<UnsignedValueEvt const*>(e);
...
void FSP::Pattern_handleErrorAndDispatchToCard(QP::QActive* const ao,
                                               QP::QEvt const* e) {
  Pattern* const pattern = static_cast<Pattern* const>(ao);
...
void FSP::Pattern_dispatchFindPatternToCard(QP::QActive* const ao,
                                            QP::QEvt const* e) {
  Pattern* const pattern = static_cast<Pattern* const>(ao);
  pattern->card_->dispatch(&constants::find_pattern_evt, pattern->m_prio);
}

void FSP::Pattern_updateAnalogClosedLoopValues(QP::QActive* const ao,
                                               QP::QEvt const* e) {
  Pattern* const pattern = static_cast<Pattern* const>(ao);
...
void FSP::Card_storeAnalogClosedLoopParameters(QHsm* const hsm, QEvt const* e) {
  Card* const card = static_cast<Card* const>(hsm);
  AnalogClosedLoopEvt const* aclev = static_cast<AnalogClosedLoopEvt const*>(e);
...
void FSP::Card_checkPattern(QHsm* const hsm, QEvt const* e) {
  ...
  if ((uint64_t)(pattern_header.frame_count_x * byte_count_per_frame +
                 constants::pattern_header_size) != card->file_size_) {
    QS_BEGIN_ID(USER_COMMENT, AO_Pattern->m_prio)
...
uint16_t FSP::frameIndexToAnalogOutputValue(uint16_t frame_index,
...
**/
void FSP::appendMessage(uint8_t* response, uint8_t& response_byte_count,
                        const char* message) {
...
**/
uint8_t FSP::processBinaryCommand(
  ...
  switch (command_byte) {
    ...
    case SET_REFRESH_RATE_CMD: {
      ...
      UnsignedValueEvt* uvev = Q_NEW(UnsignedValueEvt, SET_REFRESH_RATE_SIG);
...
void FSP::processStreamCommand(uint8_t const* stream_buffer,
