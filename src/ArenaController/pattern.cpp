...
// void Pattern::printFileInformation()
// {
//   ExFile file;
//   pat_dir_.rewind();
...
// void Pattern::printPatFileHeaders()
// {
//   ExFile file;
//   pat_dir_.rewind();
//   while (file.openNext(&pat_dir_, O_RDONLY))
...
// void Pattern::writeDummyFramesToFile(const char * filename, uint16_t frame_count, uint8_t panel_columns_per_frame, uint8_t panel_rows_per_frame)
// {
...
// bool Pattern::openFileForWriting(const char * filename)
// {
//   return file_.open(&tpa_dir_, filename, O_WRITE | O_CREAT | O_EXCL);
// }

// bool Pattern::openTpaFileForReading(const char * filename)
// {
...
// void Pattern::rewindTpaFileForReading()
// {
//   file_.rewind();
//   file_position_ = 0;
...
bool Pattern::openPatternFileForReading(uint16_t pattern_id)
{
...
void Pattern::rewindPatternFileForReading()
{
  // file_.rewind();
  // file_position_ = 0;
  // file_.read(&tpa_header_, pattern::tpa_header_size);
