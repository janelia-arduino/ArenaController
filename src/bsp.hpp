...
struct BSP
{
  ...
  static uint16_t
  decodePatternFrameBuffer (const uint8_t *const pattern_frame_buffer,
                            bool grayscale);
  ...
  static void scanPatternDirectory ();
  ...
  static void
  readPatternFrameFromFileIntoBuffer (uint8_t *buffer, uint16_t frame_index,
