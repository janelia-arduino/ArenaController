...
# Avoid Org-Babel treating PlantUML stereotypes like <<nested0>> and <<choice>>
# as Noweb references during export, and never evaluate shell/diagram blocks
# during export.
#+PROPERTY: header-args:plantuml :exports none :results none :eval never-export :noweb no
#+PROPERTY: header-args:sh :eval never-export
#+PROPERTY: header-args:text :eval never-export
...
#+BEGIN_SRC emacs-lisp :exports none :noweb yes :eval yes
(format-time-string "%m-%d")
#+END_SRC

#+RESULTS: release-month-day
: 01-16
...
#+BEGIN_SRC emacs-lisp :noweb yes :exports none :results raw :eval yes
(let* ((refs (split-string "<<references>>" "\n" t))
       (refs-org (mapconcat (lambda (s) (concat "  - " s)) refs "\n")))
  (concat
...
#+BEGIN_SRC plantuml :file ../documentation/images/state-diagram-watchdog.png :results none :exports none :noweb no
@startuml
!theme spacelab
...
#+BEGIN_SRC plantuml :file ../documentation/images/state-diagram-serial-command-interface.png :results none :exports none :noweb no
@startuml
!theme spacelab
skinparam backgroundColor #9F9F9F
<style>
...
#+BEGIN_SRC plantuml :file ../documentation/images/state-diagram-ethernet-command-interface.png :results none :exports none :noweb no
@startuml
!theme spacelab
skinparam backgroundColor #9F9F9F
<style>
...
#+BEGIN_SRC plantuml :file ../documentation/images/state-diagram-pattern.png :results none :exports none :noweb no
@startuml
!theme spacelab
skinparam backgroundColor #9F9F9F
<style>
...
#+BEGIN_SRC plantuml :file ../documentation/images/state-diagram-card.png :results none :exports none :noweb no
@startuml
!theme spacelab
skinparam backgroundColor #9F9F9F
<style>
...
#+BEGIN_SRC text :tangle ../pixi.toml :exports none :noweb yes
# This file is generated automatically from .metadata.org
# File edits may be overwritten!
[workspace]
authors = ["<<author>> <<lt>><<author-email>><<gt>>"]
channels = ["conda-forge"]
description = "<<description>>"
name = "G4.1-<<library-name>>"
platforms = ["linux-64"]
version = "<<library-version>>"
